...
1) It is common practice in HEP to use ROOT (https://root.cern.ch/) and root files as data analysis framework and data storage format. The cool kids this days abhor it (for a number of good reasons combined with a fair amount of pretentiousness). 
